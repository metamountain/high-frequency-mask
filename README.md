...
Two more grids live in `docs/` if you want them — `detector-grid.jpg` (guided filter
vs. the original high pass) and `edges-grid.jpg` (grow vs. feather) — generated by
`docs/make_detector_grid.py` and `docs/make_edges_grid.py`.
